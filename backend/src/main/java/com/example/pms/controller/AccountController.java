...
public class AccountController {
    ...
    @GetMapping("/log")
    public String loginPage(@RequestParam(name = "passwordChanged", required = false) String passwordChanged,
            HttpSession session,
            Model model) {
        ...
        if ("1".equals(passwordChanged)) {
            model.addAttribute("success", "Password changed successfully! Please sign in again.");
        }
        return "login";
    }
